package se.ayar.atmLaboration.service.test;
...
public class ATMTest
{
	...
	private long checkedBalance = 200;
	...
	public void setUp() throws Exception
	{
		...
		when(bank.withdrawAmount(accountHolderId, amount)).thenReturn(balance - amount);
	...
	public void shouldWithdrawAmount()
	{
		...
		verify(bank).withdrawAmount(accountHolderId, amount);
		verify(bank).getBalance(atmCard.getAccountHolderId());
	}
}
